...
class _ModelZooUrls(object):
    ...
    note_ROHIT -- Further Details read the MODEL_ZOO.md -- 
    COCO-Detection/faster_rcnn_R_50_FPN_3x" -- here 3x ==  trained with the 3x schedule (~37 COCO epochs)
    COCO-Detection/faster_rcnn_R_50_FPN_1x" -- here 1x ==  trained with the 1x schedule (~12 COCO epochs)
    SOURCE -- https://github.com/facebookresearch/detectron2/blob/main/MODEL_ZOO.md
    """
